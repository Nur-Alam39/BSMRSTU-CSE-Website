<div class='row' style='margin:0;padding:0;height:400px;'>
<div id="accordion col-lg-3" style='padding-left:2%;'>
		  <div class="card">
			...
			<div id="collapseOne1" class="collapse show" aria-labelledby="headingOne1" data-parent="#accordion">
				  <div class="card-body">
					...
					<input class='form-control-inline' type='date' name='date' id='date'>
				  </div>
				</div>
			  </div>
			  <div class="card">
				...
				<div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordion">
				  <div class="card-body">
					...
					<input class='form-control-inline' type='time' name='time' id='time'>
				  </div>
				</div>
			  </div>
			  <div class="card">
		...
		<div id="accordion col-lg-3" style='padding-left:2%;'>
		  <div class="card">
			...
			<div id="collapseOne5" class="collapse show" aria-labelledby="headingOne5" data-parent="#accordion">
				  <div class="card-body">
					<label for="headline">Experience:</label> 
					<input class='form-control-inline' type='text' name='experience' id='experience'>
				  </div>
			</div>
		   </div>
			  <div class="card">
				...
				<div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#accordion">
				  <div class="card-body">
					<label for="time">Publication:</label> 
					<input class='form-control-inline' type='text' name='publication' id='publication'>
				  </div>
				</div>
			  </div>
			  <div class="card">
				...
				<div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#accordion">
				  <div class="card-body col-lg-12">
						<div class="form-group">
							<label for="headline">Research</label>
		...
		<div id="accordion col-lg-3" style='padding-left:2%;'>
		  <div class="card">
			...
			<div id="collapse8" class="collapse show" aria-labelledby="heading8" data-parent="#accordion">
				  <div class="card-body">
					<label for="headline">Text File:</label> 
					<input class='form-control-inline' type='file' name='text' id='text'>
				  </div>
			</div>
		   </div>
			  <div class="card">
				...
				<div id="collapse9" class="collapse" aria-labelledby="heading9" data-parent="#accordion">
				  <div class="card-body">
					<div class="form-group">
						<label for="time">Image File:</label> 
						<input class='form-control-inline' type='file' name='img_file' id='img_file'>
					</div>
				  </div>
				</div>
			  </div>
			  <div class="card">
				...
				<div id="collapse10" class="collapse" aria-labelledby="heading10" data-parent="#accordion">
				  <div class="card-body col-lg-12">
						<div class="form-group">
							<label for="headline">PDF file:</label>
